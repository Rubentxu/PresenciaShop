...
import presencia.digital.config.audit.AuditEventConverter;
import presencia.digital.domain.PersistentAuditEvent;
...
import static presencia.digital.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
